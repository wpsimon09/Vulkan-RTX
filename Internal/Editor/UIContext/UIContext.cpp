...
void UIContext::SetColourThemePabloLight()
{
    ...
    // Colors (Light Mode with Subdued Green Accent for Active)
    ...
    colors[ImGuiCol_PopupBg]               = ImVec4(0.80f, 0.80f, 0.80f, 0.94f);
    colors[ImGuiCol_Border]                = ImVec4(0.60f, 0.60f, 0.60f, 0.70f);
    colors[ImGuiCol_BorderShadow]          = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
    ...
    colors[ImGuiCol_Header]                = ImVec4(0.75f, 0.75f, 0.75f, 0.55f);
    ...
    colors[ImGuiCol_SeparatorActive]       = ImVec4(0.50f, 0.50f, 0.50f, 1.00f);
    colors[ImGuiCol_ResizeGrip]            = ImVec4(0.70f, 0.70f, 0.70f, 0.25f);
    ...
    colors[ImGuiCol_TabActive]             = ImVec4(0.40f, 0.60f, 0.40f, 1.00f);  // Active Green (more muted)
    ...
    colors[ImGuiCol_PlotHistogramHovered]  = ImVec4(0.55f, 0.55f, 0.55f, 1.00f);
