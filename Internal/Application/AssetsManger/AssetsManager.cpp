...
namespace ApplicationCore
{
    ...
    void AssetsManager::GetTexture(std::shared_ptr<ApplicationCore::VTextureAsset>& texture, const std::string& path,
                                   bool saveToDisk)
    {
        if (!m_textures2.contains(path))
        {
            m_textures2[path] = std::make_shared<ApplicationCore::VTextureAsset>(
                m_device, m_dummyImage, ETextureAssetType::Texture, path);
                                   ...
                                   TextureBufferInfo& data, bool saveToDisk)
    {
        ...
        {
            m_textures2[data.textureID] = std::make_shared<ApplicationCore::VTextureAsset>(
                m_device, m_dummyImage, ETextureAssetType::Texture, data);
                                      ...
                                      bool saveToDisk)
    {
        ...
        {
            m_HDRTextures[path] = std::make_shared<ApplicationCore::VTextureAsset>(
                m_device, m_dummyImage, ETextureAssetType::HDRTexture, path);
