...
{
    m_compositeEffect->SetNumWrites(1, 5, 0);
    ...
    m_compositeEffect->WriteBuffer(currentFrameIndex, 0, 5, uniformBufferManager.GetGlobalBufferDescriptorInfo()[currentFrameIndex]);
