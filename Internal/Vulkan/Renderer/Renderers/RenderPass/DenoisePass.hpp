...
{
  public:
    BilateralFilterPass(const VulkanCore::VDevice& device,VulkanCore::VDescriptorLayoutCache& descLayoutCache,const  VulkanCore::VImage2& inputImage, int width, int height);
...
private:
  const VulkanCore::VImage2& m_inputImage;
