    ...
    : m_device(device)
{
    ...
    m_pushDescriptors[EDescriptorLayoutStruct::UnlitSingleTexture] =
        std::make_shared<VShaderResourceGroup>(m_device, std::string("Unlit single texture"), std::move(layout));
    ...
    m_pushDescriptors[EDescriptorLayoutStruct::ForwardShading] =
        std::make_shared<VShaderResourceGroup>(m_device, std::string("Forward shading dst set"), std::move(layout));
    ...
    m_pushDescriptors[EDescriptorLayoutStruct::Basic] =
        std::make_shared<VShaderResourceGroup>(m_device, std::string("Basic descriptor set"), std::move(layout));
    ...
    m_pushDescriptors[EDescriptorLayoutStruct::RayTracing] =
        std::make_shared<VShaderResourceGroup>(m_device, std::string("Ray tracing descriptor set"), std::move(layout));
    ...
    m_pushDescriptors[EDescriptorLayoutStruct::PostProcessing] =
        std::make_shared<VShaderResourceGroup>(m_device, std::string("Postprocessing descriptor set"), std::move(layout));
}
