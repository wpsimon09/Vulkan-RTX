...
namespace VulkanUtils {
    ...
    public:
        ...
        void DestroyBuffer(std::unique_ptr<VulkanCore::VBuffer> vBuffer, bool isStaging = false);
    ...
    private:
        ...
        std::vector<std::pair<bool, std::unique_ptr<VulkanCore::VBuffer>>> m_clearVBuffers;
