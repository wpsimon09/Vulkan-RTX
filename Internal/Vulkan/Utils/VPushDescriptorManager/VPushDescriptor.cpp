...
void VulkanUtils::VPushDescriptorSet::CreateUpdateEntries(VulkanUtils::DescriptorSetTemplateVariant& teamplate)
{
...
void VulkanUtils::VPushDescriptorSet::CreateUpdateEntry(VulkanCore::VGraphicsPipeline& pipelineLayout)
{
