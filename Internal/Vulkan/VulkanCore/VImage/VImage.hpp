...
class VImage : public VulkanCore::VObject
{
  public:
    ...
    explicit VImage(const VulkanCore::VDevice&         device,
                    vk::Image                          image,
                    int                                widht,
                    int                                height,
    ...
    void TransitionImageLayout(vk::ImageLayout                      currentLayout,
    ...
    bool IsSavable() const { return m_saveable; }
  ...
  public:
    ...
    [[nodiscard]] const vk::Image& GetImage() const { return m_imageVK; }

    [[nodiscard]] const vk::ImageView& GetImageView() const { return m_imageView; }

    [[nodiscard]] uint32_t GetMipLevelels() const { return m_mipLevels; }

    [[nodiscard]] vk::Format GetFormat() const { return m_format; }

    [[nodiscard]] const vk::Format& GetFormatConstRef() const { return m_format; }

    [[nodiscard]] const vk::ImageAspectFlags& GetAspectFlag() const { return m_aspectFlags; }
