...
VulkanCore::VImage::VImage(const VulkanCore::VDevice&         device,
                           ...
                           std::optional<vk::ImageUsageFlags> usageFlags,
...
VulkanCore::VImage::VImage(const VulkanCore::VDevice&         device,
                           ...
                           vk::Format                         format,
                           vk::ImageAspectFlags               aspecFlags,
                           std::optional<vk::ImageUsageFlags> imageUsage,
                           vk::SampleCountFlagBits            samples)
    : m_device(device)
    , m_mipLevels(mipLevels)
    , m_format(format)
...
void VulkanCore::VImage::TransitionImageLayout(vk::ImageLayout                      currentLayout,
