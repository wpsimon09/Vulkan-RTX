...
vk::AccelerationStructureBuildSizesInfoKHR VulkanCore::RTX::AccelerationStructBuildData::FinalizeGeometry(
    const VulkanCore::VDevice& device, vk::BuildAccelerationStructureFlagsKHR flags)
{
    ...
    device.GetDevice().getAccelerationStructureBuildSizesKHR(vk::AccelerationStructureBuildTypeKHR::eDevice, &asBuildGoemetryInfo, maxPrimitiveCount.data(), &asBuildSizesInfo, device.DispatchLoader);
