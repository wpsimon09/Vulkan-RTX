...
inline DesiredDeviceFeatures primaryDeviceFeatures = {
    ...
    .deviceFeatures = vk::PhysicalDeviceFeatures{}.setGeometryShader(VK_TRUE).setSamplerAnisotropy(VK_TRUE),
};

inline DesiredDeviceFeatures secondaryDeviceFeatures = {.deviceType = vk::PhysicalDeviceType::eIntegratedGpu,
                                                        .deviceFeatures = vk::PhysicalDeviceFeatures{}.setSamplerAnisotropy(VK_TRUE)
